...
const recommendedPluginRulesConfigTypeChecked = {
...
const recommendedPluginRulesConfigBase = {
...
const flatRecommendedGeneralRules = {
    ...
    "obsidianmd/no-nodejs-modules": manifest && manifest.isDesktopOnly ? "off" : "warn",
