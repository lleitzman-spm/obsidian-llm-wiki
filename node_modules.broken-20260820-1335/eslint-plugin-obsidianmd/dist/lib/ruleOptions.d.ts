...
export declare const restrictedImportsOptions: readonly [{
    ...
    readonly message: "The 'moment' package is bundled with Obsidian. Import the `moment` value from 'obsidian' instead. For the `Moment` type, rely on the global `moment` namespace or add `type Moment = moment.Moment;` (type-only imports from 'moment' are allowed).";
    readonly allowTypeImports: true;
}];
export declare const noUnusedExpressionsOptions: readonly [{
