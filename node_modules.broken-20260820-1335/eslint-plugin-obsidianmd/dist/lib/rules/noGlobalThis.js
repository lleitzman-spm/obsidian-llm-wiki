...
export default ruleCreator({
    meta: {
        type: "suggestion",
        docs: {
            description: "Disallow `global` and `globalThis`. Use `window` or `activeWindow` for popout window compatibility.",
            url: docsUrl("no-global-this"),
        },
        schema: [],
        fixable: "code",
        messages: {
            avoidGlobal: "Avoid using '{{name}}'. Use 'window' or 'activeWindow' for popout window compatibility.",
        },
    },
    defaultOptions: [],
    create(context) {
