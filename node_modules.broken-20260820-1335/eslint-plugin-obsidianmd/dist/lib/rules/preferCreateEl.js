...
export default ruleCreator({
    meta: {
        ...
        messages: {
            ...
            preferCreateElSuggestion: "Replace '{{original}}' with '{{replacement}}'.",
        },
    },
    defaultOptions: [],
    create(context) {
        const services = ESLintUtils.getParserServices(context);
        function hasObsidianDomHelpers(node) {
            const type = services.getTypeAtLocation(node);
            return type.getProperty("createEl") !== undefined;
        }
        function winHasObsidianDomHelpers(node) {
            const type = services.getTypeAtLocation(node);
        ...
        function report(node, replacement, canAutofix) {
