...
export default ruleCreator({
    meta: {
        type: "suggestion",
        docs: {
            description: "Prefer `window.setTimeout()` and related timer functions over bare global calls for popout window compatibility.",
            url: docsUrl("prefer-window-timers"),
        },
        schema: [],
        fixable: "code",
        messages: {
            preferWindowTimer: "Use 'window.{{name}}()' instead of '{{name}}()' for popout window compatibility.",
            noActiveWindowTimer: "Use 'window.{{name}}()' instead of 'activeWindow.{{name}}()'. Timer functions should use 'window'.",
        },
    },
    defaultOptions: [],
    create(context) {
