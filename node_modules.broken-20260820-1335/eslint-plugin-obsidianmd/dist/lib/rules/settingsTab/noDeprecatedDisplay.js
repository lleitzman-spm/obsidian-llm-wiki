...
import { DECLARATIVE_MIN_VERSION, findClassMember, isPluginSettingTab, minAppVersionSchema, resolveMinAppVersion, } from "./shared.js";
export default ruleCreator({
    meta: {
        type: "suggestion",
        docs: {
            description: "Disallow a leftover display() method on PluginSettingTab subclasses once getSettingDefinitions() is implemented and minAppVersion is 1.13.0 or later.",
            url: docsUrl("no-deprecated-display", "settings-tab"),
        },
        schema: minAppVersionSchema,
        fixable: "code",
        messages: {
            deprecatedDisplay: "minAppVersion is {{minAppVersion}} and getSettingDefinitions() is implemented, so this display() method is deprecated and bypassed by Obsidian. You can remove it.",
        },
    },
    defaultOptions: [{}],
    create(context) {
        ...
        function memberRemovalRange(member) {
