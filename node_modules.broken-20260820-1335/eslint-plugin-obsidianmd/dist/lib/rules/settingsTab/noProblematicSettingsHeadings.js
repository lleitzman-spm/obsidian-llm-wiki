        ...
        return {
            ...
            "CallExpression[callee.property.name='setHeading']"(node) {
                ...
                while (current.object.type === TSESTree.AST_NODE_TYPES.CallExpression) {
                    ...
                    if (innerCall.callee.type === TSESTree.AST_NODE_TYPES.MemberExpression &&
                ...
                if (current.object.type === TSESTree.AST_NODE_TYPES.NewExpression &&
                ...
                if (textArg?.type !== TSESTree.AST_NODE_TYPES.Literal ||
